...
<body class="bg-gradient-to-b from-[#A8D5BA] to-[#FFD9B3]">
    ...
    <div class="md:hidden flex flex-col min-h-screen">
        ...
        <!-- Navbar bawah -->
        <nav class="{{ request()->is('/') || request()->is('cart') ? 'hidden' : '' }} fixed bottom-0 left-0 right-0 bg-[#b4926a] h-20 flex justify-around items-center shadow-lg z-50 rounded-t-xl overflow-hidden">
